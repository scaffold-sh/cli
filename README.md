...
Scaffold is a "catalog" of cloud infrastructures that you could use to create a complete infrastructure on your own [AWS](https://aws.amazon.com) account, in seconds.
